        ...
        <div className="bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden">
          <table className="w-full">
            <thead className="bg-gray-200">
              <tr>
                <th className="px-6 py-4 text-left text-xs font-bold text-white uppercase tracking-wider">{t("common.action")}</th>
                <th className="px-6 py-4 text-left text-xs font-bold text-white uppercase tracking-wider">{t("dashboard.event_code")}</th>
                <th className="px-6 py-4 text-left text-xs font-bold text-white uppercase tracking-wider">{t("dashboard.event_name")}</th>
              </tr>
            </thead>
