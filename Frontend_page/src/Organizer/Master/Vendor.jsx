...
import { Eye, Plus, X, CheckCircle, AlertCircle,Info } from "lucide-react";
...
export const VendorPage = () => {
  ...
  className={`w-full border p-2 rounded bg-white focus:ring-2 focus:ring-sky-500 outline-none ${
    fieldErrors.primary_contact ? "border-red-500" : "border-sky-200"
  }`}
/>
  ...
  className={`w-full border p-2 rounded bg-white focus:ring-2 focus:ring-sky-500 outline-none ${
    fieldErrors.secondary_contact ? "border-red-500" : "border-sky-200"
  }`}
/>
                    </div>
