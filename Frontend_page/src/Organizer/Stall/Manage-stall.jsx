                            ...
                            <thead>
                                <tr className="bg-sky-600 text-white">
                                    {tableHeaders.map((header, index) => (
                                        <th 
                                            key={index}
                                            className={`${header.sortable ? 'cursor-pointer hover:bg-slate-50 transition-colors' : ''} ${index === 0 ? 'border-r border-slate-100' : 'border-r border-slate-100 last:border-r-0'} px-5 py-3 text-left text-[14px] font-semibold uppercase tracking-wider`}
                                        >
