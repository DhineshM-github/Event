                  ...
                  {(formData.terms || []).length === 0 ? (
                    ...
                    (formData.terms || []).map((p, i) => (
                      <tr key={i} className="hover:bg-sky-50/50 transition-colors duration-200 group">
                        ...
                        {/* Policy Group */}
                        <td className="px-6 py-4 border-b border-gray-100 text-sm font-semibold text-gray-800">
                          {p.policyGroup}
                        </td>
                        ...
                        {/* Policy Name */}
                        <td className="px-6 py-4 border-b border-gray-100 text-sm text-gray-700 font-medium">
                          {p.policyName}
                        </td>
