...
const Step6VendorSponsor = ({ formData, setFormData }) => {
  ...
  // ===========================
  const inputClasses =
    "w-full h-[45px] px-6 py-2 rounded-full bg-white border border-gray-200 text-gray-800 transition-all duration-200 focus:outline-none focus:border-purple-500 focus:ring-4 focus:ring-purple-500/10 placeholder:text-gray-400 text-sm font-bold";
  ...
  const labelClasses =
    "block text-[11px] font-black text-gray-500 mb-1.5 ml-4 uppercase tracking-wider";
  const cardClasses =
  ...
  const tableCellClasses =
    "p-4 text-sm text-gray-800 border-b border-gray-50/50 font-medium";
