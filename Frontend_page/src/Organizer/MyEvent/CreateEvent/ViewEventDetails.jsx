              ...
              <div className="space-y-6">
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 h-full">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="pt-2">
                       <p className="text-xs font-bold text-gray-500 uppercase mb-2">On-Spot Requirements</p>
                       <div className="flex gap-2 flex-wrap">
                    ...
                    <div className="pt-2 border-t border-gray-50">
                       <p className="text-xs font-bold text-gray-500 uppercase mb-2">Mandatory Documents</p>
                       <div className="flex gap-2 flex-wrap">
          ...
          {activeTab === 2 && (
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 max-w-4xl mx-auto">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-6">
                    <h4 className="text-sm font-bold text-indigo-600 uppercase tracking-wider border-b pb-2">Schedule & Limits</h4>
                    <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-6">
                    <h4 className="text-sm font-bold text-indigo-600 uppercase tracking-wider border-b pb-2">Form Visibility Configuration</h4>
                  ...
                  <div className="space-y-6 md:col-span-2 mt-4">
                    <h4 className="text-sm font-bold text-indigo-600 uppercase tracking-wider border-b pb-2">Pricing & Entry</h4>
                   ...
                   <div className="overflow-x-auto">
                     <table className="w-full">
                       <thead className="bg-gray-50 text-gray-600">
                         <tr>
                           <th className="px-6 py-4 text-left text-xs font-bold text-white uppercase tracking-wider">Stall Name</th>
                           <th className="px-6 py-4 text-left text-xs font-bold text-white uppercase tracking-wider">Size</th>
                           ...
                           <th className="px-6 py-4 text-left text-xs font-bold text-white uppercase tracking-wider">Price (INR)</th>
                           <th className="px-6 py-4 text-left text-xs font-bold text-white uppercase tracking-wider">Prime Price (INR)</th>
                           <th className="px-6 py-4 text-left text-xs font-bold text-white uppercase tracking-wider">Prime Seat Check</th>
                         </tr>
                       </thead>
               ...
               <div className="bg-white p-10 rounded-[2.5rem] shadow-xl shadow-gray-200/50 border border-gray-100 relative overflow-hidden">
                 ...
                 {(!documents?.docs || documents.docs.length === 0) ? (
                   <div className="flex flex-col items-center justify-center py-16 bg-gray-50/50 rounded-[2rem] border border-dashed border-gray-200">
                     ...
                     <p className="text-gray-500 font-bold uppercase tracking-widest text-xs">No documents uploaded</p>
                   </div>
                 ) : (
                             ...
                             {doc.file_url ? (
                               doc.file_type?.includes('image') ? (
                                 ...
                                 <div className="w-full h-full flex flex-col items-center justify-center bg-slate-800 text-slate-500 gap-3">
                                   ...
                                   <span className="text-[10px] font-black uppercase tracking-[0.2em]">Non-Image Document</span>
                                 </div>
                               )
                             ) : (
                               <div className="w-full h-full flex flex-col items-center justify-center text-gray-300">
                                 <FileText size={48} className="mb-2 opacity-50" />
                                 <span className="text-[10px] font-black uppercase tracking-tighter">Document Preview</span>
                               </div>
                             )}
                            ...
                            {doc.doc_number && (
                              <div className="mt-auto pt-4 border-t border-gray-50">
                                <div className="flex items-center gap-2 text-xs">
                                   ...
                                   <span className="text-gray-400 font-bold uppercase tracking-widest text-[9px]">Document ID</span>
                                </div>
          ...
          {activeTab === 6 && (
            <div className="space-y-8 max-w-5xl mx-auto">
               <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                 ...
                 {/* Vendors */}
                 <div className="mb-8">
                   <h4 className="text-sm font-bold text-indigo-600 uppercase tracking-wider border-b pb-2 mb-4">Vendors</h4>
                   {(!vendors || vendors.length === 0) ? (
                     <p className="text-gray-500 text-sm italic">No vendors attached.</p>
                   ) : (
                 ...
                 {/* Sponsors */}
                 <div className="mb-8">
                   <h4 className="text-sm font-bold text-indigo-600 uppercase tracking-wider border-b pb-2 mb-4">Sponsors</h4>
                   {(!sponsors || sponsors.length === 0) ? (
                     <p className="text-gray-500 text-sm italic">No sponsors attached.</p>
                   ) : (
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                       {sponsors.map((v, idx) => (
                 ...
                 {/* Guests */}
                 <div>
                   <h4 className="text-sm font-bold text-indigo-600 uppercase tracking-wider border-b pb-2 mb-4">Guests</h4>
                   {(!guests || guests.length === 0) ? (
                     <p className="text-gray-500 text-sm italic">No guests attached.</p>
                   ) : (
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                       {guests.map((v, idx) => (
                         <div key={idx} className="p-5 bg-gray-50 rounded-xl border border-gray-100 transition">
